...
cp ../sysport/target/aarch64-apple-darwin/release/$BINARY_NAME $DIST_DIR/$BINARY_NAME
echo "[OK] Built $BINARY_NAME for macOS arm64."
...
echo "[SUCCESS] macOS arm64 build complete. Artifacts in $DIST_DIR/" 